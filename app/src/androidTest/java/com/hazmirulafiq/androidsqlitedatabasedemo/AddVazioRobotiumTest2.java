...
public class AddVazioRobotiumTest2 extends ActivityInstrumentationTestCase2<AddItem> {
    private Solo solo;
    private AddVazioPageObject additemPage;
    private MainActivity vwItem;

    public AddVazioRobotiumTest2(){
        super(AddItem.class);
    }
    ...
    // TESTE 2
    public void testPreenchimentoVazio() throws Exception{
